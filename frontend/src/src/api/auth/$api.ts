    ...
    auth: {
      checkSignedIn: {
        ...
        get: (option?: { config?: T | undefined } | undefined) =>
          fetch<
            Methods_rmdwew["get"]["resBody"],
            BasicHeaders,
            Methods_rmdwew["get"]["status"]
      ...
      signIn: {
         ...
         */
        post: (option: {
          body: Methods_20ilnn["post"]["reqBody"];
          config?: T | undefined;
        }) =>
          fetch<
            Methods_20ilnn["post"]["resBody"],
            BasicHeaders,
            Methods_20ilnn["post"]["status"]
      ...
      signUp: {
         ...
         */
        post: (option: {
          body: Methods_1ybobht["post"]["reqBody"];
          config?: T | undefined;
        }) =>
          fetch<
      ...
      validateSignUp: {
         ...
         */
        post: (option: {
          body: Methods_1hyhucz["post"]["reqBody"];
          config?: T | undefined;
        }) =>
          fetch<
